...
Revision ID: 6211928976dc
Revises: a4db7ca02b8d
Create Date: 2020-07-05 02:59:22.660020
...
revision = '6211928976dc'
down_revision = 'a4db7ca02b8d'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.Column('seeking_talent_description', sa.VARCHAR(), autoincrement=False, nullable=True),
